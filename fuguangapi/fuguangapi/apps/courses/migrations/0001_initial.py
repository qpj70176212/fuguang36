    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_type', models.SmallIntegerField(choices=[(0, '初级'), (1, '中级'), (2, '高级')], default=1, verbose_name='付费类型')),
                ...
                ('price', models.DecimalField(decimal_places=2, default=0, max_digits=10, verbose_name='课程原件')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lesson_link', models.CharField(blank=True, help_text='若是video，填视频地址或者视频id，若是文档，填文档地址', max_length=255, verbose_name='课程链接')),
        ...
        migrations.AddField(
            model_name='course',
            name='teacher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='course_list', to='courses.teacher'),
        ),
    ]
